...
<%
	...
	sql =	"SELECT * FROM tbl_galeria " & Nome_SQL & " ORDER BY " & Ordena & ""
	'Executa
...
<div id="global">
    ...
    <div id="content">
        ...
        <h2><span></span>Galeria de Foto</h2>
        ...
        <form name="selecao" id="selecao" action="act_exc.asp" method="POST">
       	...
       	<table class="content_table">
            <tr>
                ...
                <th><div class="content_table_title_arrow"></div><a href="lista.asp?Ordena=nome"><strong>Galeria</strong></a></th>
        ...
        <%
			Else
				...
				Espetaculo = Rs("id_empreendimento")
					...
					sqlEspetaculo = "SELECT id_empreendimento, nome FROM tbl_empreendimento WHERE id_empreendimento = " & Espetaculo
        ...
        <tr class="content_table_line1">
            ...
            <td onClick="location.href='frm_vis.asp?id_galeria=<%=Rs("id_galeria")%>'"><%=nome_espetaculo%></td>
