...
<%
	...
	sqlG =	"SELECT * FROM tbl_galeria_planta WHERE id_galeria = " & id_galeria
	'Executa
	...
	sql =	"SELECT * FROM tbl_galeria_planta_foto WHERE id_galeria = " & id_galeria & " ORDER BY id_foto ASC"
	'Executa
	Rs.Open	sql, conexao
...
<div id="global">
    ...
    <div id="content">
        ...
        <h2><span></span>Galeria de Planta | Imagens / <%=nome_galeria%></h2>
        <div class="content_divisao"></div>      
        
        <a href="lista.asp?lista=todos&amp;limpa=ok" class="content_link1">Listar Galerias de Plantas</a></td>
        <i><%= msg %></i>
