...
<div id="global">
    ...
    <div id="content">
        ...
        <h2><span></span>Usu&aacute;rios | Editar</h2>
        ...
        <form name="formulario" action="act_edt.asp?UsuarioID=<%= UsuarioID %>" method='post'>
		...
		<div class="form_entry">
            ...
            <input type="text" name="txtEmail" id="txtEmail" disabled maxlength="255" size="50" value="<%= Email %>" class="form_textarea" />      
        </div>
        <div class="form_entry">
            <div class="form_title"><h3>Login</h3></div>
            <input type="text" name="txtLogin" id="txtLogin" disabled maxlength="255" size="50" value="<%= Login %>" class="form_textarea" />      
        </div>
		<div class="form_entry">
