...
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;" width="80">Endereço da Imagem:</td>
    ...
    <input type="hidden" name="imageurl" id="imageurl" value=""  style="font-size: 10px; width: 100%;">
    <button id="procurar" name="procurar" onClick="window.open('../../../elearning_banco_de_imagens/lista_indice.asp','','location=0,status=0,scrollbars=0,resizable=0,width=600,height=500,scrollbars=yes');">Procurar</button></td>
 </tr>
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Legenda da Imagem:</td>
    ...
    <input type="text" name="alt" id="alt" value=""  style="font-size: 10px; width: 100%;"></td>
 </tr>
</table>
