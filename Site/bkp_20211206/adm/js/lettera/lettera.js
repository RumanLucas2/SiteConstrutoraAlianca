...
// Images Directory
imagesDir = "../js/lettera/icons/";

// CSS Directory
cssDir = "../js/lettera/styles/";

// Popups Directory
popupsDir = "../js/lettera/popups/";
...
// Order of available commands in toolbar two
	...
	buttonName2[3]  = "createlink";
	buttonName2[4]  = "seperator";
	buttonName2[5]  = "undo";
	buttonName2[6]  = "redo";
	buttonName2[7]  = "seperator";
	buttonName2[8]  = "viewSource";
	//buttonName2[10]  = "insertimage";
	//buttonName2[11]  = "insertimage_url";
	//buttonName2[12]  = "createlink";
	//buttonName2[13]  = "seperator";
	//buttonName2[14]  = "viewSource";
	//buttonName2[9]  = "inserttable";
	//buttonName2[10]  = "insertimage";
	//buttonName2[11]  = "insertimage_url";
	//buttonName2[12]  = "createlink";
	//buttonName2[13]  = "seperator";
	//buttonName2[14]  = "viewSource";
	//buttonName2[1] = "unorderedlist";
	//buttonName2[2] = "orderedlist";
	//buttonName2[3] = "outdent";
	//buttonName2[4] = "indent";
...
function gera_lettera(textareaID) {
  ...
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
	...
	toolbar += '<td style="width: 0px;" style="display:none;"><span id="FontSelect' + n + '"  style="display:none;"></span></td>';
	toolbar += '<td style="width: 0px;" style="display:none;"><span id="FontSizes'  + n + '"  style="display:none;"></span></td>';
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      var currentColor = _dec_to_rgb(document.getElementById("wysiwyg" + n).contentWindow.document.queryCommandValue(id));
	    ...
	    window.open(popupsDir + 'select_color.asp?color=' + currentColor + '&command=' + id + '&wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,width=' + popW + ',height=' + popH + ',top=' + topPos + ',left=' + leftPos);
    }

		// InsertImage
	  	else if (id == "InsertImage") {
		window.open(popupsDir + 'insert_image.asp?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=260');
	  }
	  
	   // InsertImage URL
	  	else if (id == "InsertImage_URL") {
		window.open(popupsDir + 'insert_image_url.asp?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=300,height=80');
	  }

		// InsertTable
	  	else if (id == "InsertTable") {
	    window.open(popupsDir + 'create_table.asp?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=360');
	  }

		// CreateLink
	  	else if (id == "CreateLink") {
	    window.open(popupsDir + 'insert_hyperlink.asp?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=310,height=110');
	  }
	    ...
	    window.open(popupsDir + 'about.asp','popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=330');
	  }
