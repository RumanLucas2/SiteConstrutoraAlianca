...
{
	document.location = "index_mobile.asp";
} else {
...
<div id="global">
    ...
    <div class="login_column1">
    	...
    	<div class="login_text_box2">
	        ...
	        <p>Para sua segurança,<br />digite a senha utilizando<br />o teclado virtual.</p>
    ...
    <div class="login_column2">
    	...
    	<div class="login_form">
            ...
            <form action="act_login.asp" method="post" name="frmLogin" id="frmLogin">
            	...
            	<div class="text_box"><span>Senha</span><input name="txtSenha" type="password" class="keyboardInput" id="txtSenha" onKeyPress="alert('Para sua segurança, utilize o teclado virtual');return false;" value="" /></div>
            ...
            <div class="login_bt_holder">
                ...
                <div class="login_bt_contact"><a href="#">Fale<br />conosco</a></div>
            </div>
