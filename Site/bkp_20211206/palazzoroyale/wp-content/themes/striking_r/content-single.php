...
<?php 
if(!theme_get_inherit_option($post_id, '_show_in_header', 'blog','show_in_header')):
...
<?php if((theme_get_option('general','introduce') && $type!=='default') || !theme_get_option('general','introduce')): ?>
			<h1 class="entry-title"><a href="<?php echo get_permalink() ?>" rel="bookmark" title="<?php printf( __("Permanent Link to %s", 'theme_front'), get_the_title() ); ?>"><?php the_title(); ?></a></h1>
<?php endif;?>
